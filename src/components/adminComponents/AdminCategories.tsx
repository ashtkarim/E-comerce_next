...
import { AiOutlineLoading3Quarters } from "react-icons/ai"; // fixed import
          ...
          <div className="flex flex-col w-full bg-muted text-muted-foreground border-primary-foreground rounded-lg p-4 min-h-96">
            <div className="flex flex-row w-full items-start justify-between">
              <div className="flex flex-col w-full">
                <h2 className="text-primary text-xl font-bold">Categories list</h2>
                <h2 className="text-sm font-normal mb-4">Browse all categories</h2>
              </div>
              <AdminNewCatDialog>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="w-full font-semibold">Category title</TableHead>
